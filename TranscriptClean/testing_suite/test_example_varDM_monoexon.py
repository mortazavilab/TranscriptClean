...
class TestCorrectTranscripts2(object):
    def test_DIM_nc_full(self):
        ...
        #            "--g", f"{test_dir}/input_files/hg38_chr11.fa", "-j",
        #            f"{test_dir}/input_files/chr11_sjs.txt",
        #            "--variants", f"{test_dir}/input_files/vcf_test/chr11_variantDel.vcf",
        #            "--maxLenIndel", "5",
        #            "--maxSJOffset", "5", "--correctMismatches", "True",
        #            "--correctIndels", "True", "--correctSJs", "True", "--primaryOnly",
        #            "--o", f"{test_dir}/scratch/vDM/TC"]
        ...
        with open(f"{test_dir}/scratch/vDM/TC_clean.sam", 'r') as f:
            header = f.readline()
            header = f.readline()
            header = f.readline()
        ...
        with open(f"{test_dir}/scratch/vDM/TC_clean.log", 'r') as f:
